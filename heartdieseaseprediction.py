...
Original file is located at
    https://colab.research.google.com/drive/1mOyuEAhjZTQd7PovlhQhs_MarJaGqZ1N

**import libries for HDP**
"""
...
# Set up the subplot for categorical features (5x2 layout)
...
for i, col in enumerate(categorical_features):
    ...
    ax[i].set_xlim([0, 100]) # Adjusted x-limit for percentages
